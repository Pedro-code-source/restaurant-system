...
public class MainPedidoOnlineDeleteAll {
    public static void main(String[] args) throws PersistenciaDawException {
        ...
        System.out.println("Encontrados " + todos.size() + " pedidos online para deletar.");

        for (PedidoOnline c : todos) {
            pedidoOnlineDAO.delete(c.getId());
        }

        List<PedidoOnline> restantes = pedidoOnlineDAO.getAll();
        System.out.println("Pedidos online restantes no banco: " + restantes.size());
